...
LANGUAGE.data = {
	...
	[ "System_Notify_ExternalXUpdateNeed" ] = "캐서린의 새로운 패치가 발표되었습니다, 설치하시려면 시스템 메뉴를 방문하세요.",
	...
	[ "Basic_Info_Loading" ] = "완벽한 캐서린을 위해 불러오는 중 입니다 ...",
	[ "Basic_Error_Reloading" ] = "캐서린을 다시 로딩하는 중 입니다 ...",
	[ "Basic_Framework_Author" ] = "롤 플레잉 프레임워크 개발 및 디자인 '%s'",
