...
function PANEL:Init( )
	...
	self.leftPanel.Paint = function( pnl, w, h )
		local symbolW, symbolH = 270 / 3, 512 / 3
	...
	self.classicMenu:SetStrColor( Color( 0, 0, 0, 255 ) )
	self.classicMenu:SetGradientColor( Color( 0, 0, 0, 255 ) )
	...
	self.classicMenu.PaintBackground = function( pnl, w, h )
	...
	self.disconnect.PaintBackground = function( pnl, w, h )
		draw.RoundedBox( 0, 0, 0, w, h, Color( 235, 235, 235, 255 ) )
		draw.RoundedBox( 0, 5, 5, h - 10, h - 10, Color( 255, 150, 150, 255 ) )
	end
	...
	self.close:SetGradientColor( Color( 0, 0, 0, 255 ) )
...
function PANEL:Paint( w, h )
	...
	draw.RoundedBox( 0, w - tw - 20, h - th - 10, tw + 10, th, Color( 255, 255, 255, 255 ) )
	draw.SimpleText( versionText, "catherine_normal20", w - 15, h - 20, Color( 0, 0, 0, 255 ), TEXT_ALIGN_RIGHT, 1 )
end
