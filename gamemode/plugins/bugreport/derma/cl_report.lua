...
function PANEL:Init( )
	...
	self.warningLabel:SetFont( "catherine_font01_20" )
	...
	self.titleLabel:SetFont( "catherine_font01_20" )
	...
	self.titleEnt:SetFont( "catherine_font01_15" )
	...
	self.valueLabel:SetFont( "catherine_font01_20" )
	...
	self.valueEnt:SetFont( "catherine_font01_15" )
	...
	self.sendReport:SetFont( "catherine_font01_20" )
...
function PANEL:MenuPaint( w, h )
	if ( self.notifyMessage ) then
		catherine.util.DrawCoolText( self.notifyMessage, "catherine_font01_25", w / 2, h / 2 )
		return
	end
