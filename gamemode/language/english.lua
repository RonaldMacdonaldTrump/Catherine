...
LANGUAGE.data = {
	...
	[ "Character_Notify_CharBanned" ] = "This character are banned!",
	...
	[ "Character_Notify_MaxLimitHit" ] = "You can't create more character!",
	[ "Character_Notify_CharBan" ] = "%s are banned %s character.",
	[ "Character_Notify_CharUnBan" ] = "%s are unbanned %s character.",
	...
	[ "Item_DropQ_Wallet" ] = "What are you want amount for drop money?",
